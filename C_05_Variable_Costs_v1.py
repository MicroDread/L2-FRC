...
def get_expenses(exp_type):
    ...
    # default amount to 1 fixed expenses and
    ...
    while True:
        ...
        if ((exp_type == "variable" and item_name == "xxx")
                and len(all_items) == 0):
            print("Oops - you have entered anything.  "
    ...
    # Calculate Row Cost
    expense_frame['Cost'] = expense_frame['Amount'] * expense_frame
...
print()
variable_panda = variable_expenses
variable_subtotal = variable_expenses
